<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="practica3_bd1.Index" %>
		...
		<section>
			<div class="tab-content tabs-login col-lg-12 col-md-12 col-sm-12 cols-xs-12">
				<div id="login-access" class="tab-pane fade active in">
					<h2><i class="glyphicon glyphicon-log-in"></i>Centro de Cálculo</h2>						
        ...
        $('#submit').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    if (msg.d == "1") {
                        window.location.href = "/Code/Administrativo.aspx";

                    } else if (msg.d == "2" ) {
                        window.location.href = "/Code/Profesor.aspx";
                    } else if ( msg.d == "3") {
                        window.location.href = "/Code/Estudiante.aspx";
                    }
                    else {
                        $('#mensaje').removeClass();
